...
#This is used to convert our images and bounding box coordinates to numpy arrays.

image_path = '../Text_detection_ai/B_box_text_images/Img_BounbBox/images'
gt_path = '../Text_detection_ai/B_box_text_images/Img_BounbBox/ground_truth'
train_image_paths = []
train_gt_paths = []
...
np.save('../Text_detection_ai/B_box_text_images/Data/X.npy',X)
np.save('../Text_detection_ai/B_box_text_images/Data/Y.npy',Y)